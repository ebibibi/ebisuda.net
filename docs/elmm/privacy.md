---
title: プライバシーポリシー - English Learn Movie Maker (ELMM)
navbar: false
sidebar: false
---
...
本アプリケーションは、個人が語学学習動画を自動生成しYouTubeに公開するために開発・運用しているものです。一般ユーザー向けのサービスとして提供するものではありません。
...
本アプリケーションがYouTube APIを通じてアクセスするデータは以下の通りです。

- **YouTube Data API**: 運営者自身のYouTubeチャンネルへの動画アップロード、メタデータの設定、再生リストの管理
- **YouTube Analytics API**: 運営者自身のYouTubeチャンネルの視聴回数、視聴維持率等のパフォーマンス指標の取得
