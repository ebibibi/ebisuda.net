...
<details class="about-me">
  ...
  <p>1979年茨城県鹿嶋市生まれ。2002年3月に筑波大学 情報学群を卒業後、都内の独立系SIerに入社。Windowsインフラを中心に、数人から数万人規模の企業システムの設計・構築・運用に従事。エンジニア向けの技術サポートやトレーニング、製品検証、技術的課題のあるプロジェクトにも直接参加し、多数のイベントで登壇。</p>
